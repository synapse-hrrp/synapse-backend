...
return new class extends Migration {
    ...
    {
        Schema::create('gynecologies', function (Blueprint $t) {
            $t->uuid('id')->primary();
            ...
            // Données cliniques principales (français)
            ...
            $t->string('tension_arterielle', 20)->nullable(); // ex: "120/80"
    ...
    {
        Schema::dropIfExists('gynecologies');
    }
};
