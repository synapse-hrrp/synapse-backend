...
class KinesitherapieUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'intensite_douleur'=> ['sometimes','nullable','integer','min:0','max:10'],
            'echelle_borg'     => ['sometimes','nullable','integer','min:0','max:10'],
            ...
            'statut'           => ['sometimes','nullable','in:planifie,en_cours,termine,annule'],
        ];
    }
}
