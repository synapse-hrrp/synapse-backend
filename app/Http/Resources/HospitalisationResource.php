...
class HospitalisationResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            ...
            'notes'                => $this->notes,
            'prise_en_charge'      => $this->prise_en_charge_json,
            ...
            'medecin_traitant' => $this->whenLoaded('medecinTraitant', fn() => [
                'id' => $this->medecinTraitant->id,
                'nom' => $this->medecinTraitant->nom ?? null,
            ]),
